...
<body>
  ...
  <?php endif; ?>
  <form name="reviewForm" action="../../Food Delivery System/controllers/reviewController.php" method="post" onsubmit="return validateForm()">
  <p>
  ...
  <div class="dashboard">
                ...
                <a href="../../Food Delivery System/controllers/reviewIndex.php?action=view_reviews">View Reviews & Ratings</a>
            </div>
  <br>
</body>
</html>
